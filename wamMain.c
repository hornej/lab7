...
#include "../interval_timers/intervalTimer.h"  // Modify as necessary to point to your intervalTimer.h
#include "supportFiles/leds.h"
#include "supportFiles/interrupts.h"
#include "../switches_buttons_lab/switches.h"  // Modify as necessary to point to your switches.h
#include "../interval_timers/buttons.h"   // Modify as necessary to point to your buttons.h
#include <stdio.h>
